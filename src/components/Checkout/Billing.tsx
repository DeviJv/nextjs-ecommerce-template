  ...
  return (
    <div className="">
      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div className="mb-5">
          <label htmlFor="customer_country" className="block mb-2.5">
            Country/ Region
          ...
          <div className="relative">
            <select
              ...
              defaultValue={customer.country || "Indonesia"}
            >
        ...
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
          ...
          <div className="w-full">
            <label htmlFor="customer_city" className="block mb-2.5">
        ...
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
          <div className="w-full">
            <label htmlFor="customer_state" className="block mb-2.5">
