                      ...
                      <form className="space-y-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex gap-1">
                            {[...Array(5)].map((_, i) => (
                              <button key={i} type="button" className="text-gray-300 hover:text-orange-400 transition-colors">
                        ...
                        <div>
                          ...
                          <textarea rows={4} className="w-full rounded-md border border-gray-3 bg-gray-1 p-4 outline-none focus:border-blue transition-all" placeholder="Write your review..."></textarea>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-sm font-medium mb-2">Name*</label>
                            <input type="text" className="w-full rounded-md border border-gray-3 bg-gray-1 p-2.5 outline-none focus:border-blue transition-all" placeholder="Your name" />
                          </div>
                          <div>
                            <label className="block text-sm font-medium mb-2">Email*</label>
                            <input type="email" className="w-full rounded-md border border-gray-3 bg-gray-1 p-2.5 outline-none focus:border-blue transition-all" placeholder="Your email" />
                          </div>
                        </div>

                        <button type="submit" className="w-full bg-blue text-white font-bold py-3 rounded-md hover:bg-blue-dark transition-colors mt-2">
                          Submit Review
                        </button>
                      </form>
                    </div>
