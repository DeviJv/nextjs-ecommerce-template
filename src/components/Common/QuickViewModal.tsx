  ...
  return (
    <div
      className={`${isModalOpen ? "z-99999" : "hidden"
        } backdrop-blur-sm fixed top-0 left-0 overflow-y-auto no-scrollbar w-full h-screen sm:py-20 xl:py-25 2xl:py-[230px] bg-dark/70 sm:px-8 px-4 py-5`}
    >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        key={i}
                        className={i < (product.average_rating || 0) ? "fill-[#FFA645]" : "fill-gray-4"}
                        width="18"
                        height="18"
                        viewBox="0 0 18 18"
                        fill="none"
                  ...
                  <span>
                    <span className="font-medium text-dark"> {product.average_rating || 0} Rating </span>
                    <span className="text-dark-2"> ({product.reviews_count || 0} reviews) </span>
                  </span>
                </div>
