      ...
      try {
        ...
        const mapped = json.data.map((p: ApiProduct) => {
          const image = p.primary_image
            ? `${process.env.NEXT_PUBLIC_STORAGE_URL}/${p.primary_image}`
    ...
    <section className="overflow-hidden pt-17.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        ...
        <div className="mb-7 flex items-center justify-between">
          <div>
            <span className="flex items-center gap-2.5 font-medium text-primary mb-1.5">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <h2 className="font-serif font-semibold text-xl xl:text-heading-5 text-dark">
              New Arrivals
            </h2>
