...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group bg-white rounded-lg shadow-1 overflow-hidden h-full flex flex-col">
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div className="absolute right-0 bottom-0 translate-x-full flex flex-col gap-2 p-5 ease-linear duration-300 group-hover:translate-x-0">
          <button
            onClick={() => {
