                ...
                >
                  <span className="inline-block relative">
                    <svg
                      ...
                      className="text-dark hover:text-blue transition-colors"
                    >
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2.5 -top-2 bg-red w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                </button>
            ...
            >
              ...
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  ...
                  {/* Mobile Auth Links */}
                  <li className="xl:hidden border-t border-gray-3 pt-4 mt-2">
                    {isLoggedIn ? (
                      <Link
                        href="/my-account"
                        className="flex items-center gap-2.5 font-medium text-custom-sm text-dark hover:text-blue py-2"
                      >
                        My Account
                      </Link>
                    ) : (
                      <div className="flex flex-col gap-4">
                        <Link
                          href="/signin"
                          className="font-medium text-custom-sm text-dark hover:text-blue py-2"
                        >
                          Login
                        </Link>
                        <Link
